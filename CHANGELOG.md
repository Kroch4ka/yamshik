...
- Domain models v0.1 (DESIGN.md §6): `Money`, `Contact`, `Company`, `Point`, `Item`, `Place`, `PlaceItem`, `PlaceLabel`, `ParcelService`, `Parcel`, `TrackingEvent` — immutable value objects/entities with constructor validation.
